...
printf "Now the script will update OS and install all the necessary software.\n"
...
apt-get -y install mcrypt imagemagick php7.0 php7.0-common php7.0-gd php7.0-imap php7.0-mysql php7.0-cli php7.0-cgi php7.0-zip php-pear php-auth php7.0-mcrypt php-imagick php7.0-curl php7.0-mbstring php7.0-bcmath php7.0-xml php7.0-soap php7.0-opcache php7.0-intl php-apcu php-mail php-mail-mime php-memcached php-all-dev php7.0-dev
